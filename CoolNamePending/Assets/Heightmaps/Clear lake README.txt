...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Clear+lake&box=-122.707685,39.078636,-122.800262,39.006771
...
-----------
  ...
  * Clear lake Height Map (ASTER 30m).png
  ...
  * Clear lake Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Clear lake Height Map (SRTM3 v4.1).png
  ...
  * Clear lake Height Map (SRTM30 Plus).png
  ...
  * Clear lake Height Map (USGS NED 10m).png
...
These heightmaps were adjusted such that 391m (actual) is equal to 40m in
